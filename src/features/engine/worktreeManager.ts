...
import { ENGINE_WORKTREE_ROOT } from './constants.js';
...
export class WorktreeManager {
  ...
  constructor(repoRoot = process.cwd(), worktreeRootName = ENGINE_WORKTREE_ROOT) {
    this.repoRoot = resolveRepoRoot(repoRoot);
    this.worktreeRootPath = path.join(this.repoRoot, worktreeRootName);
  }
