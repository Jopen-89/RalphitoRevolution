...
[READ_ONLY_GLOBS]: ["scripts/**/*.ts", "docs/**/*.md", "package.json"]
[WRITE_ONLY_GLOBS]: ["scripts/qa-fixture-server.ts", "scripts/qa-pipeline-smoke.ts", "docs/specs/projects/qa-pipeline-smoke/**/*.md", "package.json"]
[BANNED_GLOBS]: ["src/**", "vendor/**"]
...
- El fixture debe vivir en `scripts/` y servir solo para validar el pipeline QA.
...
```json
{
  "qaConfig": {
    ...
    "enableE2eQa": true,
    "e2eShadowMode": true,
    "devServerCommand": "npx tsx scripts/qa-fixture-server.ts",
